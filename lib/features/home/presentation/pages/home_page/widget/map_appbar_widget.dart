                              ...
                              children: [
                                (userData!.isDeletedAt.isNotEmpty)
                                    ...
                                    : ((((userData!.ownerId == '' && userData!.lowBalance == false) ||
                                          (userData!.ownerId != '' && userData!.vehicleTypeName != '' &&
                                             userData!.lowBalance == false)) ||
                                            (userData!.ownerId != '' && userData!.vehicleTypeName != '')) &&
                                            ((userData!.driverMode == 'subscription' && userData!.isSubscribed! && !userData!.isExpired!) ||
                                             (userData!.driverMode == 'commission' && !userData!.lowBalance) ||
                                             (userData!.driverMode == 'both' && !userData!.lowBalance)))
                                        ? OnlineOfflineWidget(cont: context)
                                        : (userData!.vehicleTypeName == '')
                                            ? FleetNotAssignedWidget(
                                                cont: context)
                                            : (userData!.driverMode == 'subscription' && userData!.hasSubscription !=null && userData!.hasSubscription! && 
