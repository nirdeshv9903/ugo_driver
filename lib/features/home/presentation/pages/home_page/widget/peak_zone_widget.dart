            ...
            child: InkWell(
              ...
              onTap: () async {
                if (!context.read<HomeBloc>().showPeakZones) {
                  ...
                  context.read<HomeBloc>().polygons.removeWhere((element) => element.polygonId.value.contains('peakzone_'));
                  context.read<HomeBloc>().polyline.removeWhere((element) => element.polylineId.value.contains('peakzone_'));
