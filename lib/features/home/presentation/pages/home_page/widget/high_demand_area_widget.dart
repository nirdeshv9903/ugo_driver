    ...
    return BlocProvider.value(
      ...
      child: BlocBuilder<HomeBloc, HomeState>(
        builder: (context, state) {
          ...
          DateTime date = DateTime.fromMillisecondsSinceEpoch(endTimestamp * 1000,isUtc:true);
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    MyText(
                      text: AppLocalizations.of(context)!.endsInMins.replaceAll('**',date.difference(DateTime.now().toUtc()).inMinutes.toString()),
                      textStyle: Theme.of(context)
                          .textTheme
                          .bodyMedium!
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                MyText(
                                  text: '${dist.toStringAsFixed(2)} ${userData?.distanceUnit ?? 'KM'}',
                                  textStyle: Theme.of(context)
                                      .textTheme
                                      .bodyMedium!
