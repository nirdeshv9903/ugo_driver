...
class StopVerifyOtpEvent extends HomeEvent {
  ...
  StopVerifyOtpEvent({required this.otp, required this.stopId});
}
...
class ShowZoneNavigationEvent extends HomeEvent {
  ...
  ShowZoneNavigationEvent( {required this.zoneName,required this.zoneLatLng,required this.endTimestamp});
}
