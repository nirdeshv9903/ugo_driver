...
class RideUsecases {
  ...
  Future<Either<Failure, CancelRequestModel>> cancelRequest(
    ...
    return _rideRepository.cancelRequest(requestId: requestId, reason: reason, choosenReason: choosenReason);
  }
  ...
  Future<Either<Failure, AdditionalCharges>> additionalChargeApi(
    ...
    {required String stopId,required String otp})async{
      return _rideRepository.stopOtpVerify(stopId: stopId, otp: otp);
    }
}
