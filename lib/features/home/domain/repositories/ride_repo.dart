...
// import 'package:appzeto_taxi_driver/features/home/domain/models/additional_charges_model.dart';
...
abstract class RideRepository {
  ...
  Future<Either<Failure, CancelRequestModel>> cancelRequest(
      {required String requestId, required String reason, String? choosenReason});
  ...
  Future<Either<Failure, dynamic>> stopOtpVerify({required String stopId,required String otp});    
}
